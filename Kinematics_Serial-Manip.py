...
def KUKA_chain_from_jnt_angles( Theta1 = 0 , Theta2 = 0 , Theta3 = 0 , Theta4 = 0 , Theta5 = 0 , Theta6 = 0):
    ...
    if Theta2 >  45 or Theta2 < -190:
        raise RuntimeWarning("Theta 2 was out of bounds! " + str(Theta2))
...
#                            Q05 )
    ...
    return sum_vector_chain( [ startpoint , d_01 , d_12 , d_23 , d_34 , d_45 , d_56 ] )

    
linkPoints = KUKA_chain_from_jnt_angles(0,0,0,0,0,0)
print linkPoints
...
def link_update_from_chain(linkPoints, segmentList):
    #print linkPoints
    print "Sim side:", segmentList[1].bgn, segmentList[1].end
    for index in range(1,len(linkPoints)):
